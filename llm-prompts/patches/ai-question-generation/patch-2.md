# [ai-question-generation] Patch 2: Question schemas and repository interface + stub
...
Patch 1 added the `question` table in `src/server/db/schema-app.ts` and the migration under `drizzle/`.
...
- Branch from: `main`
- Branch name: `ai-question-generation/patch-2-question-schemas-repository`
- PR base: `main`
...
```bash
gh pr create --draft --title "[ai-question-generation] Patch 2: Question schemas and repository interface + stub" --body "Work in progress" --base main
```
