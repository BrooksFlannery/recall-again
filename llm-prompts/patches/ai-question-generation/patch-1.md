# [ai-question-generation] Patch 1: Question table and migration
...
- Branch from: `main`
- Branch name: `ai-question-generation/patch-1-question-table-migration`
- PR base: `main`
...
```bash
gh pr create --draft --title "[ai-question-generation] Patch 1: Question table and migration" --body "Work in progress" --base main
```
