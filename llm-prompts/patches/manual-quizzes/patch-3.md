# [manual-quizzes] Patch 3: Add quiz schemas (select + inputs)
...
## Git Instructions
- Branch from: `main`
- Branch name: `manual-quizzes/patch-3-quiz-schemas`
- PR base: `main`
...
```bash
gh pr create --draft --title "[manual-quizzes] Patch 3: Add quiz schemas (select + inputs)" --body "Work in progress" --base main
```
